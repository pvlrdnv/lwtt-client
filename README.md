...
Приложение не содержит готовых профилей серверов, сертификатов или активного файла конфигурации. Каждый пользователь добавляет свои настройки сервера самостоятельно.
